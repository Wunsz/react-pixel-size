...
const getSvgStyles = (id) => ({
    ...
    embossStyle: {
        fill: `url(#${id}-numbersGradient)`,
        fillOpacity: 1,
        stroke: '#252525',
        strokeWidth: 0.075,
    },
    backgroundStyle: {
        fill: `url(#${id}-backgroundGradient)`,
        stroke: '#000000',
        strokeWidth: '0.5',
    },
    starStyle: {
...
class CreditCard extends React.Component {
    render() {
        ...
        const { chipStrokeStyle, embossStyle, backgroundStyle, starStyle } = getSvgStyles(id);
        ...
        return (
            <svg version="1.1" viewBox="0 0 85.72500 53.97500" id={id} {...other}>
                <defs>
                    <linearGradient {...gradientProps([0, 300, 85, 240, `${id}-backgroundGradient`])}>
                    ...
                    <linearGradient {...gradientProps([30, 270, 40, 235, `${id}-numbersGradient`])}>
                        <stop offset="0" style={{stopColor: letters[0], stopOpacity: 1}} />
                        <stop offset="1" style={{stopColor: letters[1], stopOpacity: 1}} />
                    </linearGradient>
                    <linearGradient {...gradientProps([30, 260, 40, 270, `${id}-chipGradient`])}>
                    ...
                    <linearGradient {...gradientProps([70, 260, 85, 250, `${id}-starGradient`])}>
                        <stop offset="0" style={{stopColor: letters[0], stopOpacity: 1}} />
                ...
                <g transform="translate(0,-243.02499)">
                    ...
                    <g transform="matrix(0.69346115,0,0,0.69346115,-5.303983,76.631011)">
                        <rect style={{...chipStrokeStyle, fill: `url(#${id}-chipGradient)`, fillOpacity: 1}} {...cardPaths.chip.outer} />
                        <rect style={{...chipStrokeStyle, fill: `url(#${id}-chipGradient)`, fillOpacity: 1}} {...cardPaths.chip.inner} />
